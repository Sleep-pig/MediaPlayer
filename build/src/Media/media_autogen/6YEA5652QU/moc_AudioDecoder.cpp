/****************************************************************************
** Meta object code from reading C++ file 'AudioDecoder.hpp'
**
...
#include <memory>
#include "../../../../../src/Media/include/AudioDecoder.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'AudioDecoder.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 15), // "sendAudioBuffer"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 8), // "uint8_t*"
QT_MOC_LITERAL(4, 39, 11), // "audioBuffer"
QT_MOC_LITERAL(5, 51, 10), // "bufferSize"
QT_MOC_LITERAL(6, 62, 3) // "pts"

    },
    "AudioDecoder\0sendAudioBuffer\0\0uint8_t*\0"
    "audioBuffer\0bufferSize\0pts"
};
...
static const uint qt_meta_data_AudioDecoder[] = {
 ...
 // signals: parameters
    QMetaType::Void, 0x80000000 | 3, QMetaType::Int, QMetaType::Double,    4,    5,    6,
...
void AudioDecoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendAudioBuffer((*reinterpret_cast< uint8_t*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AudioDecoder::*)(uint8_t * , int , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AudioDecoder::sendAudioBuffer)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AudioDecoder::sendAudioBuffer(uint8_t * _t1, int _t2, double _t3)
{
