...
#include <memory>
#include "../../../../../src/Media/include/VideoDecoder.hpp"
...
QT_MOC_LITERAL(1, 13, 14), // "sendVideoFrame"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 8), // "uint8_t*"
QT_MOC_LITERAL(4, 38, 9), // "pixelData"
QT_MOC_LITERAL(5, 48, 10), // "pixelWidth"
QT_MOC_LITERAL(6, 59, 11), // "pixelHeight"
QT_MOC_LITERAL(7, 71, 3) // "pts"

    },
    "VideoDecoder\0sendVideoFrame\0\0uint8_t*\0"
    "pixelData\0pixelWidth\0pixelHeight\0pts"
};
...
static const uint qt_meta_data_VideoDecoder[] = {
 ...
 // signals: parameters
    QMetaType::Void, 0x80000000 | 3, QMetaType::Int, QMetaType::Int, QMetaType::Double,    4,    5,    6,    7,
...
void VideoDecoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendVideoFrame((*reinterpret_cast< uint8_t*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< double(*)>(_a[4]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (VideoDecoder::*)(uint8_t * , int , int , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoDecoder::sendVideoFrame)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoDecoder::sendVideoFrame(uint8_t * _t1, int _t2, int _t3, double _t4)
{
